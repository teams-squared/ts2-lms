        ...
        <div className="md:hidden border-t border-gray-100 bg-white">
          <div className="px-4 py-3 space-y-2">
            <Link
              ...
              className="block px-3 py-2 rounded-md text-sm font-medium text-gray-600 hover:text-brand-600 hover:bg-gray-50"
            >
              Home
            </Link>
            {session && (
            ...
            <div className="border-t border-gray-100 pt-2 mt-2">
              {session ? (
                <>
                  ...
                  <button
                    onClick={() => signOut({ callbackUrl: "/" })}
                    className="block w-full text-left px-3 py-2 rounded-md text-sm font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-50"
                  >
                    Sign Out
                  </button>
                </>
                ...
                <Link
                  href="/login"
                  onClick={() => setMobileOpen(false)}
                  className="block px-3 py-2 rounded-md text-sm font-medium bg-brand-600 text-white text-center"
                >
                  Sign In
                </Link>
              )}
