...
import { ChevronDownIcon, ChevronRightIcon, CheckCircleIcon, DocumentTextIcon, VideoIcon, QuizIcon, PaperclipIcon, LayoutGridIcon, ClockIcon, ShieldIcon, LinkIcon, AssessmentIcon } from "@/components/icons";
